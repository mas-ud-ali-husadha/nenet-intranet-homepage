    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar relative group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          <div className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 w-[1px] h-[90%] bg-gray-200 dark:bg-gray-800  items-center"></div>
          {children}
        </div>
      </div>
    </div>
...
function SidebarGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        'relative flex w-full min-w-0 flex-col p-2 items-center',
        className
      )}
      {...props}
    />
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        side="right"
        align="center"
        className='bg-card-2 text-white'
